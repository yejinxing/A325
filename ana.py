...
from main import parse_args,mysql,wavelet_denoising,normalize_signal,find_peaks,filtered_r_peaks,heartbeat_segment,find_output
...
def result_ana(filepath):
    # args = parse_args()
    triton_client = httpclient.InferenceServerClient(url="192.168.1.111:30000")
